...
Client side routing means that the client is responsible for routing to a page while server side routing sends a new request to the server each time the user executes an event.
